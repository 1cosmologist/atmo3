...
* am
*
* errlog.c                        S. Paine rev. 2023 June 27
*
...
static struct err {
    ...
    { 165, 0, 0,
        "! Warning: The observing level has been isothermally extrapolated\n"
        "!          below the lowest defined model level."},
    { 166, 0, 0,
        "! Warning: The tangent level has been isothermally extrapolated\n"
        "!          below the lowest defined model level."},
    { 167, 0, 0,
    ...
    { 176, 0, 0,
        ...
        "!          dg/dz < 0."},
    { 177, 0, 0,
        "! Warning: The source level has been isothermally extrapolated\n"
        "!          below the lowest defined model level."},
    { 178, 0, 0,
    ...
    { 187, 0, 0,
        ...
        "!        with lnum = %d"},
    { 188, 0, 0,
        "! Error: T = 0 in find_P_from_z(). This error is caused by a\n"
    ...
    {  -1, 0, 0,
        "END"}, /* end of error log table, marked by -1 in num field */
};
...
*   int data - integer data for data field
*
* Return:
