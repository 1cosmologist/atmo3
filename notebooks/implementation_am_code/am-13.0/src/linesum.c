...
* am
*
* linesum.c                         S. Paine rev. 2022 May 9
*
            ...
            case LINESHAPE_VVH_750:
                {
                    ...
                    gridsize_t jmax_neg_line, jmin_pos_line;
                    ...
                    f_max = -f0 + fc;
                    /*
                     * Break out here if the negative frequency line
                     * is outside the grid.
                     */
                    if (f_max < f[0])
                        break;
                    ...
                    if (dk == NULL || pass == 0) {
                        ...
                        /* assign to dk[] in non-overlap area */
                        for (j = jmin; j < jmin_pos_line; ++j) {
                            double r3;
                            r3 = f[j] + f0;
                            r3 *= r3;
                            dk[j] = r0 / (r1 + r3) - r2;
