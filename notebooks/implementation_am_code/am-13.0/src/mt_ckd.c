...
* am
*
* mt_ckd.c                        S. Paine rev. 2023 July 18
*
 ...
 *
 *   The MT_CKD Water Vapor Continuum - 4.1
 *
 *   Copyright ©, Atmospheric and Environmental Research, Inc.,
 *   2022   All rights reerved. This source code was developed as
 ...
 *
 *   MT_CKD_4.1: Revised foreign H2O continuum in FIR to adjust
 *   for v3.5 changes to self. For previous version information
 *   see GitHub repository Whats New Wiki
...
const double mt_ckd_for_absco_ref[] = {
 ...
 2.648408e-24, 2.122715e-24, 1.824946e-24, 1.475934e-24, 1.100543e-24,
