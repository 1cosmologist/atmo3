...
* am
*
* output.h                          S. Paine rev. 2023 May 8
*
...
/*
 * The last table entry is used to indicate states and actions affecting
 * all outputs.
 */
...
/*
 * outcol[] is an index table, defined in output.c, which maps from output
 * column numbers to entry numbers in the output[] table.  For example, if
 * the first column of program output is frequency, then outcol[0] will
 * be equal to OUTPUT_FREQUENCY.
 */
extern int outcol[];
