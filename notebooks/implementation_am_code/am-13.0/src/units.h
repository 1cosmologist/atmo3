...
* am
*
* units.h                          S. Paine rev. 2023 May 15
*
...
int convert_unit(double*, const char*);
int convert_unit_differential(double*, const char*);
...
int sprint_with_unit(char*, const char*, double, int);
